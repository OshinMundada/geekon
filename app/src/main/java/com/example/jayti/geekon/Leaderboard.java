...
public class Leaderboard extends AppCompatActivity implements ValueEventListener {
String email;
    ...
    private void addDrawerItems() {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(Leaderboard.this, "You've chosen:" +osArray[position], Toast.LENGTH_SHORT).show();
                switch (position){
                    case 0:
                        i=new Intent(Leaderboard.this,UserHome.class);
                        i.putExtra("email",email);
                        startActivity(i);
                        break;
                    case 1:
                        i=new Intent(Leaderboard.this,Profile.class);
                        i.putExtra("email",email);
                        startActivity(i);
                        break;

                    case 2:
                        i=new Intent(Leaderboard.this,Previous.class);
                        i.putExtra("email",email);
                        startActivity(i);
                        break;

                    case 3:
                        i=new Intent(Leaderboard.this,Pending.class);
                        i.putExtra("email",email);
                        startActivity(i);
                        break;
                    case 4:
                        i=new Intent(Leaderboard.this,Leaderboard.class);
                        i.putExtra("email",email);
                        startActivity(i);
                        break;
                    case 5:
